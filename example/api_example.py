...
if __name__ == '__main__':
    ...
    my_screen_result: ScreenResult = run_screen(fasta_file=example_2, engineered_kmer_threshold=20, kraken_db="/dodo/fmq1/PlasmidScreenDBNoAddgene",
                                                diamond_db="/dodo/dbs/uniref_march_2025_with_tax.dmnd",threads=60,
                                                quiet_mode=True, run_codon_usage=True, memory_mode=0,
